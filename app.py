...
CRITERIA = [
    ...
    {
        "id": 4,
        "label": "YSA family — SCHMECK tag",
        "description": "Company is YSA, YSA 2, or YSA 3 AND TextTags contains SCHMECK",
    },
    {
        "id": 5,
...
REQUIRED_COLUMNS = ["Company", "Performer/Team", "Account Email", "TextTags"]
...
def apply_filters(df: pd.DataFrame):
    ...
    rules = {
        ...
        4: company.isin(["ysa", "ysa 2", "ysa 3"]) & _tag_contains(tags, "schmeck"),
